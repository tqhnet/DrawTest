...
- (void)setupGLProgram
{
    NSString *vertFile = [[NSBundle mainBundle] pathForResource:@"vert_camera.glsl" ofType:nil];
...
{
    NSString *vertFile = [[NSBundle mainBundle] pathForResource:@"vert_camera.glsl" ofType:nil];
    NSString *fragFile = [[NSBundle mainBundle] pathForResource:@"frag_camera.glsl" ofType:nil];
