...
@interface OpenGLESManager() <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) AVCaptureSession *captureSession;         //配置
@property (nonatomic, strong) AVCaptureDeviceInput *videoInput;         //输入
@property (nonatomic, strong) AVCaptureVideoDataOutput *videoOutput;    //输出

@end

@implementation OpenGLESManager
...
//    AVCaptureDeviceDiscoverySession discoverySessionWithDeviceTypes:@[] mediaType:<#(nullable AVMediaType)#> position:<#(AVCaptureDevicePosition)#>
...
- (void)processVideoSampleBufferToYUV:(CMSampleBufferRef)sampleBuffer
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        OpenGLESView_Camera *glView = (OpenGLESView_Camera *)self.view;
