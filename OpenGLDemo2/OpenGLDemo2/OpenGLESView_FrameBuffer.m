...
@interface OpenGLESView_FrameBuffer()
{
...
@implementation OpenGLESView_FrameBuffer
...
- (void)setupGLProgram
{
    NSString *vertFile1 = [[NSBundle mainBundle] pathForResource:@"overlap_vert.glsl" ofType:nil];
    NSString *fragFile1 = [[NSBundle mainBundle] pathForResource:@"special_mosaic.glsl" ofType:nil];
...
{
    NSString *vertFile = [[NSBundle mainBundle] pathForResource:@"overlap_vert.glsl" ofType:nil];
    NSString *fragFile = [[NSBundle mainBundle] pathForResource:@"special_gray.glsl" ofType:nil];
...
- (void)render
{
    ...
    //这里用了framebuffer1来进行离屏渲染_program1
    glBindFramebuffer(GL_FRAMEBUFFER, _frameBuffer1);
